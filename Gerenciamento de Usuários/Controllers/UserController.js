class UserController{
    ...
    getValues(formEl){
        ...
        [...formEl.elements].forEach(function(field){ //converte o objeto em array por meio do spread
        ...
        return new User(user.name, user.gender, user.birth, user.country, user.password, user.photo, user.admin, user.email);
    }
    ...
    /**
     *Recebe o valor da tr
     *
     * @param {*} dataUser
     * @param {*} [tr=null]
     * @returns retona a tr com os valores do usuário
